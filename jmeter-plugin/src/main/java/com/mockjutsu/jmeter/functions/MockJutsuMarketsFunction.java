...
public final class MockJutsuMarketsFunction extends MockJutsuBaseFunction {
    ...
    @Override protected String typeDescription() {
        return "isin | cusip | sedol | lei | fix_message | psd2_consent | figi | nsin | stock_ticker | forex_pair | forex_rate | ric | mic | stock_exchange | option_contract | bond_yield | coupon_rate | settlement_date | portfolio_id | portfolio_id_masked";
    }
}
