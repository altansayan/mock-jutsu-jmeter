...
public final class MockJutsuComplianceFunction extends MockJutsuBaseFunction {
    ...
    @Override protected String typeDescription() {
        return "policy_number | claim_number | pep_status | aml_risk_rating | cdd_level | sar_number | ubo_ownership_percentage | kyc_document_type | consent_id | tpp_id | onboarding_method | sanctions_hit";
    }
}
